...
class App extends Component {
  ...
  generateCompanyTags = function (companies) {
    const companiesTags = [];
    companies.map((c) =>
      companiesTags.push(<Company name={c.name} revenue={c.revenue} />)
    );
      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-3">
            <div>
              {companies.map((c) => (
                <Company name={this.upperCase(c.name)} />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-6">
            {this.state.companies.map((d) => (
              <Company name={d.name} revenue={d.revenue} />
            ))}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-4">
            ...
            <Home
              ...
              discount={this.state.shouldDiscount}
            />
          </div>
        </div>
      </div>
